  ...
  return (
    <div>
      <ul className="hobbiesList">
        <li className="hobbiesList__interest hand">
        ...
        <li className="hobbiesList__interest volley">
        ...
        <li className="hobbiesList__interest book">
        ...
        <li className="hobbiesList__interest travels">
        ...
        <li className="hobbiesList__interest musique">
        ...
        <li className="hobbiesList__interest moto">
        ...
        <li className="hobbiesList__interest otherInterest">
